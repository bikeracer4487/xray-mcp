...
class TestTools:
    ...
    async def get_tests(self, jql: Optional[str] = None, limit: int = 100) -> Dict[str, Any]:
    ...
    async def get_expanded_test(self, issue_id: str, test_version_id: Optional[int] = None) -> Dict[str, Any]:
