...
def standardize_error_response(
    ...
    # Log the error
    log_level = logging.ERROR if code != ErrorCode.VALIDATION_FAILED else logging.WARNING
    logger.log(
        log_level,
    ...
    def decorator(func: Callable[..., T]) -> Callable[..., Union[T, Dict[str, Any]]]:
        ...
        def wrapper(*args, **kwargs) -> Union[T, Dict[str, Any]]:
            context = ErrorContext(
                ...
                tool=args[0].__class__.__name__ if args and hasattr(args[0], '__class__') else None
            )
