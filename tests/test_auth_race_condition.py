...
class TestAuthRaceCondition:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_token_requests_single_auth(self, auth_manager, mock_token_data):
    ...
    @pytest.mark.asyncio
    async def test_sequential_calls_use_cached_token(self, auth_manager, mock_token_data):
    ...
    async def test_token_refresh_near_expiry(self, auth_manager):
        ...
        near_expiry_token = jwt.encode(near_expiry_payload, "dummy_secret", algorithm="HS256")
    ...
    @pytest.mark.asyncio
    async def test_lock_prevents_duplicate_auth_on_slow_network(self, auth_manager, mock_token_data):
