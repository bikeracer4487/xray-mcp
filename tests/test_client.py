...
class TestXrayGraphQLClient:
    ...
    @pytest.mark.asyncio
    async def test_execute_query_retry_on_transient_error(self, client, mock_auth_manager):
        ...
        mock_response_fail.text = AsyncMock(return_value="Service temporarily unavailable")
        
        mock_response_success = AsyncMock()
        mock_response_success.status = 200
        mock_response_success.json = AsyncMock(return_value={"data": {"test": "success"}})
