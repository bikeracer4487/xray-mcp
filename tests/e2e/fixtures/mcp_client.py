...
class XrayMCPClient:
    ...
    async def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> TestResponse:
        """
        ...
        Returns:
            TestResponse with results or error information
        """
        try:
            ...
            if hasattr(result, 'content'):
                ...
                for item in content_list:
                    if hasattr(item, 'text'):
                        try:
                            ...
                            return TestResponse(success=True, data=data)
                        except json.JSONDecodeError:
                            return TestResponse(success=True, data={"raw": item.text})
                
                # Fallback for non-text content
                return TestResponse(success=True, data={"content": str(result.content)})
            
            elif isinstance(result, dict):
                # Direct dictionary response
                return TestResponse(success=True, data=result)
                ...
                try:
                    ...
                    return TestResponse(success=True, data={"raw": str(result)})
        
        except Exception as e:
            return TestResponse(success=False, data={}, error=str(e))
    ...
    async def create_test(
        ...
        project_key: str,
        summary: str,
        test_type: Union[TestType, str] = TestType.GENERIC,
        ...
        Returns:
            TestResponse with created test information
        """
    ...
    async def get_test(self, issue_id: str) -> TestResponse:
        """Get test details."""
    ...
    async def delete_test(self, issue_id: str) -> TestResponse:
        """Delete a test."""
    ...
    async def get_test_execution(self, issue_id: str) -> TestResponse:
    ...
    async def validate_connection(self) -> TestResponse:
    ...
    def extract_issue_key(self, response: TestResponse) -> Optional[str]:
    ...
    def extract_issue_id(self, response: TestResponse) -> Optional[str]:
    ...
    def assert_success(self, response: TestResponse, message: str = ""):
    ...
    def assert_contains_keys(self, response: TestResponse, required_keys: List[str]):
