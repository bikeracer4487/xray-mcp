...
class TestErrorResponse:
    ...
    def test_error_response_with_context(self):
        ...
        context = ErrorContext(operation="create_test", tool="TestTools")
    ...
    def test_error_response_with_details(self):
        ...
        response = ErrorResponse(error, ErrorCode.QUERY_FAILED, details=details)
...
class TestStandardizeErrorResponse:
    ...
    def test_standardize_with_context(self, mock_logger):
        ...
        error = GraphQLError("Query failed")
        context = ErrorContext(
            operation="execute_query", tool="TestTools", request_id="req123"
        )
    ...
    def test_standardize_validation_error_logging(self, mock_logger):
        ...
        mock_logger.log.assert_called_with(ANY, ANY)  # logging.WARNING
